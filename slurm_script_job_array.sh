...
#SBATCH --output=tmp45/output_%N_%j.out  # STDOUT output file
#SBATCH --error=tmp45/output_%N_%j.err   # STDERR output file (optional)
...
srun python3 /home/bg545/rigorous_ml/train.py --config_dir data_and_hsize_configs --config config_${SLURM_ARRAY_TASK_ID}.txt
srun python3 /home/bg545/rigorous_ml/morse_graph.py --config_dir data_and_hsize_configs --config config_${SLURM_ARRAY_TASK_ID}.txt